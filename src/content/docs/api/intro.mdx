...
All the required backend services for EFP can be setup easily using the [EFP-Silo Railway Template](https://docs.efp.app/production/silo/)
...
- [`ethereumfollowprotocol/services`](https://github.com/ethereumfollowprotocol/services)
