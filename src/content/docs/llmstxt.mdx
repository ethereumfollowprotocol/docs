...
- [https://docs.efp.app/llms.txt](https://docs.efp.app/llms.txt) Minimal EFP context for internet connected agents
- [https://docs.efp.app/llms-full.txt](https://docs.efp.app/llms-full.txt) Full EFP context for local agents
