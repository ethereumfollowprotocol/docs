...
- [https://docs.efp.app/llms.txt](https://docs.efp.app/llms.txt) Minimal EFP context for remote agents [<a href="https://docs.efp.app/llms.txt" download="llms">Download</a>]
- [https://docs.efp.app/llms-full.txt](https://docs.efp.app/llms-full.txt) Full EFP context for local agents [<a href="https://docs.efp.app/llms-full.txt" download="llms-full">Download</a>]
