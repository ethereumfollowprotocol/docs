...
![Call Endpoin](/api-link-call.png)
...
Anyone can deploy this ENS worker repository to cloudflare or host their own instance locally. Read more about deploying [here](https://github.com/v3xlabs/enstate?tab=readme-ov-file#-cloudflare-workers).  Once you've deployed the ENS worker, just update the API's [environment variables](#api) to point to your instance.
...
| `ENS_API_URL`                   | URL for ENS worker (default: https://ens.ethfollow.xyz) |
