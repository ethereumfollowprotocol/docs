...
(TODO: change description to List URI)
...
_dApps should first check the Primary List value for an Ethereum account, and if set, default to using that EFP List for that Ethereum account._
...
### Followers/Following Calculation
