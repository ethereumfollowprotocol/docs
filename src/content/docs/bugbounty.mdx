...
Up to $5,000 USD (paid exclusively in Ethereum L1 based USDC) for each verified bug in the smart contracts listed below, depending on the severity and impact of the vulnerability, determined at our discretion.
...
Bugs, fix, or suggested improvements to the EFP app, Indexer, API, and other EFP-related code can be reported as issues on their respective repos and are not covered by this bug bounty program.
...
- Only report vulnerabilities related to Ethereum Follow Protocol's smart contracts.
