---
title: EFP List Records
---

# EFP List Records

A **List Record** is a fundamental data structure representing a record in an EFP List.

Each `ListRecord` consists of the following components:
...
Offchain, list records can be processed using dedicated types:
...
// and do not store list records directly
