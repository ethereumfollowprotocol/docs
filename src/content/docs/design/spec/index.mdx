...
**Followers** is the total number of EFP List NFTs that have at least one Entry Record with a specific Ethereum address, with the following additional conditions:
